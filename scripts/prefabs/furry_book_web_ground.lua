...
local function OnUpdate(inst, x, y, z)
    for i, v in ipairs(TheSim:FindEntities(x, y, z, 2 * TUNING.BOOK_WEB_GROUND_RADIUS, SLOWDOWN_MUST_TAGS, SLOWDOWN_CANT_TAGS)) do
...
return Prefab("furry_book_web_ground", fn, assets)
